...
def update(self, new_scale=None):
    ...
    if new_scale is not None:
        ...
        # Consume shared inf/nan data collected from .timizers to update the scale.
    ...
    # To prepare for next iteration, clear the data collected from .timizers this iteration.
